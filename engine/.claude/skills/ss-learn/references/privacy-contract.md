...
There is no network transport in the v1 CLI. MCP, team registries, and community contribution
must consume a reviewed share package rather than scanning a project directly.
